...
#define khItemEdge  13
#define khFontSize  16
...
@interface HorizontalPickerViews () <UICollectionViewDelegate, UICollectionViewDataSource>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.label.text = self.itemsArray[indexPath.item];
...
- (void)autoSelectItemWithX:(CGFloat)x {
    ...
    // 调用代理
    if ([self.delegate respondsToSelector:@selector(didSelectItem:view:)]) {
        [self.delegate didSelectItem:i view:self];
    }
